...
/**
 * Entity mapped to table "POLYLINE".
 */
public class Polyline {
    ...
    private transient PolylineDao myDao;
    ...
    public Polyline(Long id) {
        this.id = id;
    }

    public Polyline(Long id, Double lat, Double longit, String markers, Long map_layer_id) {
        this.id = id;
        this.lat = lat;
        this.longit = longit;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getPolylineDao() : null;
    }
